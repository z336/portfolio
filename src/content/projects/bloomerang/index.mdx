...
Bloomerang <a href="https://bloomerang.co/academy/" target="_blank" rel="noopener">Academy</a> is a bi-weekly webinar for Bloomerang customers to learn about features and best practices. Bloomerang's marketing site maintains a page for class registration and an archive of previous classes. For this project, I created a custom video player for viewing those previous classes.
